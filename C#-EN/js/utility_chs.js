...
$(function() {
	addFatherMeun('ModuleAPI 简介', 'ModuleAPI_Introduction');
	addSubMeun('ModuleAPI 简介', 'MODULETECH.GEN2', 'MODULETECH_GEN2');
	addSubMeun('ModuleAPI 简介', 'MODULELIBRARY', 'MODULELIBRARY');
	addSubMeun('ModuleAPI 简介', 'MODULETECH', 'MODULETECH');
	addSingleMeun('读写器生命周期', 'Reader_Life_Cycle');
	addFatherMeun('读写器参数', 'Reader_Parameters');
	addSubMeun('读写器参数', '获取参数', 'Get_Parameters');
	addSubMeun('读写器参数', '设置参数', 'Set_Parameters');
	addSubMeun('读写器参数', '参数详解', 'Parameters_Introduction');
	addSingleMeun('同步盘存标签', 'Synchronous_Inventory');
	addFatherMeun('异步盘存标签', 'ASynchronous_Inventory');
	addSubMeun('异步盘存标签', '开始盘存', 'Start_Inventory');
	addSubMeun('异步盘存标签', '停止盘存', 'Stop_Inventory');
	
	addFatherMeun('标签访问操作', 'Tag_Access');
	addSubMeun('标签访问操作', '读标签存储区', 'Read_Tag');
	addSubMeun('标签访问操作', '写标签存储区', 'Write_Tag');
	addSubMeun('标签访问操作', '写标签EPC', 'Write_Tag_EPC');
	addSubMeun('标签访问操作', '锁定标签', 'Lock_Tag');
	addSubMeun('标签访问操作', '销毁标签', 'kill_Tag');
	addFatherMeun('外设功能操作', 'Peripheral_Functions');
	addSubMeun('外设功能操作', '获取GPI', 'Get_GPI');
	addSubMeun('外设功能操作', '设置GPO', 'Set_GPO');
	addSingleMeun('错误处理', 'Error_Handling');
